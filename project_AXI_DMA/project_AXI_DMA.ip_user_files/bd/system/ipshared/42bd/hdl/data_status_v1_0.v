...
`timescale 1 ns / 1 ps
	...
	(
		...
		parameter  C_M0_AXI_TARGET_SLAVE_BASE_ADDR	= 32'h30000000,
		parameter integer C_M0_AXI_BURST_LEN	= 16,
		parameter integer C_M0_AXI_ID_WIDTH	= 1,
		parameter integer C_M0_AXI_ADDR_WIDTH	= 32,
		parameter integer C_M0_AXI_DATA_WIDTH	= 32,
		parameter integer C_M0_AXI_AWUSER_WIDTH	= 0,
...
// Instantiation of Axi Bus Interface M0_AXI
	data_status_v1_0_M0_AXI # ( 
		.C_M_TARGET_SLAVE_BASE_ADDR(C_M0_AXI_TARGET_SLAVE_BASE_ADDR),
		.C_M_AXI_BURST_LEN(C_M0_AXI_BURST_LEN),
	...
	) data_status_v1_0_M0_AXI_inst (
		.INIT_AXI_TXN(m0_axi_init_axi_txn),
		.TXN_DONE(m0_axi_txn_done),
		.ERROR(m0_axi_error),
